...
class DataBase:
    ...
    def push_found_colony(self, colony: Found_Colony_Model) -> ObjectId | None:
        ...
        if not existing_colony:
            ...
            print("colony won't be stored because it already exists")
    ...
    def create_leaked_colonies(self)  -> ObjectId | None:
        ...
        content['content'] = {"last_update": date, "registered_users": []}
    ...
    def remove_leaked_colonies(self)  -> ObjectId | None:
        self.db.leakedcolonies.delete_one({'name':'leaked_colonies'})
