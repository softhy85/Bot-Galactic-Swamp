...
class DataBase:
    ...
    def push_new_war(self, war: War_Model) -> ObjectId | None:
        actual_war: War_Model = self.db.wars.find_one({"status": "InProgress", "ally_name":war['ally_name']})
    ...
    def get_one_war(self, name: str, value: any, ally_name) -> War_Model:
        return self.db.wars.find_one({name: value, "ally_name":ally_name})
    ...
    def get_nextwar(self, ally_name) -> Next_War_Model:
